...
import com.cloud.images.crop.animation.SimpleValueAnimator;
import com.cloud.images.crop.animation.SimpleValueAnimatorListener;
import com.cloud.images.crop.animation.ValueAnimatorV14;
import com.cloud.images.crop.animation.ValueAnimatorV8;
import com.cloud.images.crop.calls.Callback;
...
public class CropImageView extends ImageView {
    ...
    private Bitmap getImage(Uri sourceUri) {
        ...
        final Bitmap sampledBitmap = CropUtils.decodeSampledBitmapFromUri(getContext(), mSourceUri, requestSize);
